...
This project is indexed by GitNexus as **DATN-api-20215485.LeThanhThuong** (3767 symbols, 6805 relationships, 92 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/DATN-api-20215485.LeThanhThuong/context` | Codebase overview, check index freshness |
| `gitnexus://repo/DATN-api-20215485.LeThanhThuong/clusters` | All functional areas |
| `gitnexus://repo/DATN-api-20215485.LeThanhThuong/processes` | All execution flows |
| `gitnexus://repo/DATN-api-20215485.LeThanhThuong/process/{name}` | Step-by-step execution trace |
